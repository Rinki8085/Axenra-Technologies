    ...
    <section className="py-24 bg-[#080d1a]">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white font-orbitron leading-tight mb-6">
          ...
          <button className="bg-[#00C2FF] text-[#0A0F1F] font-bold text-sm tracking-wide px-8 py-4 rounded hover:bg-white transition-colors">
