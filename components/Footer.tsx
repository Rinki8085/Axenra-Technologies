        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4 ml-2">
              <a href="#" className="text-brand-cool-gray hover:text-brand-cyan-blue transition-colors" aria-label="LinkedIn">
              ...
              <a href="#" className="text-brand-cool-gray hover:text-brand-cyan-blue transition-colors" aria-label="Twitter">
                <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
